...
\begin{itemize}[leftmargin=0.5cm]
  ...
  \begin{itemize}[leftmargin=0.45cm]
    \item Built a high-performance Rust BPE tokenizer and integrated it with a Python training pipeline for small language model (SLM) prototyping.
    \item Trained and validated a 35.2M-parameter TinyLM on Apple Silicon (MPS) with long-run automation (3--4 hour runs) and periodic checkpointing.
    \item Implemented checkpoint auto-ranking and stream retry/backoff logic, improving reliability for unattended arXiv-based training workflows.
    \item \href{https://github.com/JaydipSingh/subword_tokenizer}{GitHub Repo} $|$ \href{https://github.com/JaydipSingh/portfolio}{Portfolio}
  \end{itemize}
  ...
  \begin{itemize}[leftmargin=0.45cm]
    ...
    \item \href{https://github.com/JaydipSingh/agentic-video-generator}{GitHub Repo} $|$ \href{https://github.com/JaydipSingh/portfolio}{Portfolio}
  \end{itemize}
